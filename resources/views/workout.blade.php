...
<div class="container-fluid text-center d-flex justify-content-center align-items-center align-content-center py-3">
    <div class="col-md-4">
        ...
        <form action="{{ route('workout', array_merge(request()->except('search'), ['search' => request('search')])) }}" method="GET">
        ...
        @endif
            <div class="row container my-2 py-2">
                @foreach ($workouts as $workout)
                    ...
                    <div class="col-sm-12 col-md-4 mb-3 @if ($workouts->count() === 1) col-md-12 @elseif ($workouts->count() === 2) col-md-6 @endif">
...
@endif
{{-- @else
<div class="container-fluid d-flex align-items-center justify-content-center flex-column text-light my-5" style="min-height: 85vh;">
